...
public abstract class MPOperationsEnvironment {
    ...
    public static final String PROVIDER_PAP_ADDRESS = "https://pap-provider.127.0.0.1.nip.io";
    ...
    public static final String PROVIDER_TPP_DATA_API_ADDRESS = "https://tpp-data-service.127.0.0.1.nip.io";
    public static final String PROVIDER_TPP_API_ADDRESS = "https://tpp-service.127.0.0.1.nip.io";

    // direct access endpoints
    public static final String SCORPIO_ADDRESS = "https://scorpio-provider.127.0.0.1.nip.io";
    public static final String TMF_DIRECT_ADDRESS = "https://tm-forum-api.127.0.0.1.nip.io";
    public static final String CONSUMER_TMF_DIRECT_ADDRESS = "https://consumer-tmf.127.0.0.1.nip.io";
    public static final String TIL_DIRECT_ADDRESS = "https://til-provider.127.0.0.1.nip.io";
    public static final String CCS_DIRECT_ADDRESS = "https://provider-ccs.127.0.0.1.nip.io";
    public static final String RAINBOW_DIRECT_ADDRESS = "https://rainbow-provider.127.0.0.1.nip.io";
