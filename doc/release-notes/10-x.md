...
present in the patched `quay.io/seamware/keycloak:26.6.2` image shipped by the
...
KC `main` (carried by the SEAMWARE-patched `26.6.2` image — see
...
Keycloak 26.6.2 implements **[OID4VCI Draft 15](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html)**.
...
|---|---|---|---|---|---|
| [Lissi ID Wallet](https://lissi.id/) | iOS | 3.1.3 | `9c481dc3-2ad0-4fe0-881d-c32ad02fe0fc` | PKCE S256 | **Production** |
| [Lissi ID Wallet](https://lissi.id/) | Android | 3.1.1 | `9c481dc3-2ad0-4fe0-881d-c32ad02fe0fc` | PKCE S256 | **Production** |
...
> model that Keycloak 26.6.2 ships, so it cannot complete an issuance flow against the DSC's Keycloak out of the box.
...
For a worked end-to-end example, see the migrated `k3s/consumer.yaml` and `k3s/provider.yaml` overlays shipped with this release; the [`oid4vc-protocol-mappers.md`](../keycloak/oid4vc-protocol-mappers.md) reference now documents the 26.6.2 mapper API.
