...
| Document | Content |
|---|---|
| **MODEL.md** (this file) | Big picture: components, entity graph, layering, reading guide |
...
| [`service-policy.md`](./service-policy.md) | **Composed `ProductSpecification`s**: what it takes to support policies on `ServiceSpecification`s / `ResourceSpecification`s |
